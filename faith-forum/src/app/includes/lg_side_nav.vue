<template>
<aside class="h-full dark:bg-gray-800 rounded-lg border dark:border-gray-600 overflow-hidden">
...
<nav id="sidebar-multi-level-sidebar" class="z-40 w-full h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
